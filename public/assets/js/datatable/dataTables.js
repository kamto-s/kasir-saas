...
(function (factory) {
    ...
    var DataTable = function (selector, options) {
        ...
        this.each(function () {
            ...
            _fnCamelToHungarian(
                defaults,
                $.extend(oInit, _fnEscapeObject($this.data())),
                true,
            );
    ...
    function _fnCompatOpts(init) {
        ...
        if (typeof init.bSort === "object") {
            init.orderIndicators =
                init.bSort.indicators !== undefined
                    ? init.bSort.indicators
                    : true;
            init.orderHandler =
                ...
                if (
                    ...
                    if (write) {
                        ...
                        if (
                            ...
                            isHeader &&
                            jqCell.filter(":not([data-dt-order=disable])")
                                .length !== 0 &&
                            jqCell.parent(":not([data-dt-order=disable])")
                                .length !== 0 &&
                        ...
                        if (
                            $("span.dt-column-" + headerFooter, cell).length ===
                            0
                        ) {
                            $("<div>")
    ...
    [
        ...
        _api_register(
            ...
            function (selector) {
                var indexes = this.columns(selector)
                    .indexes()
                    .flatten()
                    .toArray();
                ...
                switch (match[2]) {
                    ...
                    case "visible":
                        ...
                        return columns.map(function (col, idx) {
                            ...
                            // Selector
                            if (match[1]) {
                                return $(nodes[idx]).filter(match[1]).length > 0
                                    ? idx
                                    : null;
                            }
    ...
    DataTable.type("date", {
        ...
        detect: {
            ...
            oneOf: function (d) {
                ...
                return (
                    d instanceof Date ||
                    (typeof d === "string" && _re_date.test(d))
                );
            },
        },
        order: {
    ...
    $.extend(true, DataTable.ext.renderer, {
                ...
                $(settings.nTable).on(
                    ...
                    function (e, ctx, column) {
                        ...
                        for (i = 0; i < orderedColumns.length; i++) {
                            if (
                                settings.aoColumns[orderedColumns[i]].bVisible
                            ) {
        ...
        layout: {
            _: function (settings, container, items) {
                ...
                DataTable.ext.renderer.layout._forLayoutRow(
                    items,
                    function (key, val) {
    ...
    DataTable.feature.register(
        ...
        function (settings, opts) {
            ...
            for (i = 0; i < lengths.length; i++) {
                ...
                var label = settings.api.i18n(
                    "lengthLabels." + lengths[i],
                    null,
                );
